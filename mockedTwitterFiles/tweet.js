(window.__twttrll = window.__twttrll || []).push([[8], {
  171: function(t, e, r) {
    var i = r(40)
      , n = r(173)
      , a = r(7);
    (i = Object.create(i)).build = a(i.build, null, n),
      t.exports = i
  },
  172: function(t, e, r) {
    var i = r(43)
      ...
      t.params({
        ...
        t.define("scribe", function(t, e, r) {
          ...
          return a.getHorizonSettings().then(function(a) {
            ...
            t = o.aug(n.scribeNamespace(), t || {}),
              e = o.aug(n.scribeData(), e || {}),
              i.clientEvent(t, e, !1, r, s)
          })
        }),
        t.define("scribeInteraction", function(t, e, r) {
          var i = n.extractTermsFromDOM(t.target);
          return i.action = t.type,
          "url" === i.element && (i.element = n.clickEventElement(t.target)),
            this.scribe(i, e, r)
        })
    }
  },
    ...
    s.prototype = Object.create(i.prototype),
      n.aug(s.prototype, {
        ...
        selectors: function(t) {
          ...
          t = t || {},
            this.Widget.prototype.selectors = n.aug({}, t, e)
        }
      }),
      t.exports = s
  },
      ...
      return e.prototype = Object.create(t.prototype),
        s.aug(e.prototype, {
          ...
          on: function(t, e, r) {
            var i, a = this.el;
            this.el && (t = (t || "").split(/\s+/),
              2 === arguments.length ? r = e : i = e,
              i = this.selectors[i] || i,
              r = o(r, this),
  ...
  242: function(t, e, r) {
    ...
    t.exports = s.couple(r(172), r(177), function(t) {
      t.params(p),
        t.define("getUrlParams", function(t, e) {
        ...
        t.override("render", function() {
          ...
          return f.getHorizonSettings().then(function(e) {
            var r = t.getUrlParams(e.features, e.sessionId)
              ...
              , s = u.url(n, r);
            return h(e.features, t.params.tweetId, e.sessionId),
              t.sandbox.setWaitToSwapUntilRendered(!0),
              i.all([t.sandbox.setTitle(m), t.styleSandboxWrapper({
                display: "flex",
      ...
      t.params({
        ...
        t.before("render", function() {
          ...
          switch (n && n.toLowerCase()) {
            case "center":
              t = this.params.width || this.params.centeredWidth,
                e = "auto",
                r = "auto";
              break;
            case "left":
              t = this.params.width || this.params.floatedWidth,
                r = "10px",
                i = "left";
              break;
            case "right":
